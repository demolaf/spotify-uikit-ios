...
enum BrowseSectionType {
    case newReleases(
        viewModels: [NewReleasesCellViewModel]
    ) // 1
    case featuredPlaylists(
        viewModels: [FeaturedPlaylistCellViewModel]
    ) // 2
...
class HomeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // NOTE: YOU MUST CONFIGURE THE COLLECTION VIEW AS THE FIRST SUBVIEW
        // TO GET THE TITLE OF THE VIEW CONTROLLER TO SCROLL WITH THE COLLECTION VIEW
    ...
    private func fetchData() {
        // We want to use this to combine/await multiple concurrent operations to finish
        // before executing a particular operation in this context a method
        //
